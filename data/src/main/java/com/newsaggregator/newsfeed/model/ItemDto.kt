...
fun ItemDto.toDomain(): ItemModel = ItemModel(
    ...
    categories = categories.toCategoryDomain(),
    pubDate = pubDate,
    guid = guid,
    contents = contents.toContentDomain(),
    dcCreator = dcCreator,
    dcDate = dcDate
)

fun List<CategoryDto>.toCategoryDomain(): List<CategoryModel> = map (CategoryDto::toDomain)

fun List<ContentDto>.toContentDomain(): List<ContentModel> = map (ContentDto::toDomain)
